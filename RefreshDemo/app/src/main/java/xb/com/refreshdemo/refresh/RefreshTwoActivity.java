 ...
 *
 * @author hujiao
 * @version [RefreshDemo, 2019/01/16 15:50]
 * @copyright Copyright 2010 RD information technology Co.,ltd.. All Rights Reserved.
 */

public class RefreshTwoActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshAdapter = new RefreshMultiAdapter(multiInfos, RefreshTwoActivity.this);
        refreshAdapter.setHasStableIds(true);
            ...
            public void onRefresh(@NonNull final RefreshLayout refreshLayout) {
                refreshLayout.getLayout().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        refreshAdapter.setNewData(multiInfos1);
                    }
                }, 110);
            }

...
public class RefreshBean implements Serializable {
    ...
    private int verifiedType;//认证类型，1学神/学神家长，2学霸/学霸家长，3学圣/学圣家长
    ...
    private List<String> pictures;//个人页 个人风采集合
...
//用户圆形头像地址
    ...
    public boolean isChecked() {//true 为律师   因为已认证
        return verifiedStatus == CHECKED;
    }
